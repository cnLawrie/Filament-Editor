...
export class MaterialInstance {
    ...
    public setColor3Parameter(
        name: string,
        ctype: RgbType,
        value: float3,
    ): void;
    public setColor4Parameter(
        name: string,
        ctype: RgbaType,
        value: float4,
    ): void;
...
export class RenderableManager$Builder {
    ...
    public skinningBones(
        transforms: RenderableManager$Bone[],
    ): RenderableManager$Builder;
...
export class RenderTarget$Builder {
    public texture(
        attachment: RenderTarget$AttachmentPoint,
        texture: Texture,
...
export class RenderableManager {
    ...
    public setAxisAlignedBoundingBox(
        instance: RenderableManager$Instance,
        aabb: Box,
    ): void;
    public setLayerMask(
        instance: RenderableManager$Instance,
    ...
    public setCastShadows(
        instance: RenderableManager$Instance,
        enable: boolean,
    ): void;
    public setReceiveShadows(
        inst: RenderableManager$Instance,
        enable: boolean,
    ): void;
    ...
    public setBonesFromMatrices(
        instance: RenderableManager$Instance,
        transforms: mat4[],
        offset: number,
    ): void;
    public setMorphWeights(
        instance: RenderableManager$Instance,
        a: number,
        b: number,
        c: number,
    ...
    public setMaterialInstanceAt(
        instance: RenderableManager$Instance,
        primitiveIndex: number,
        materialInstance: MaterialInstance,
    ): void;
    public getMaterialInstanceAt(
        instance: RenderableManager$Instance,
        primitiveIndex: number,
    ): MaterialInstance;
    public setGeometryAt(
        instance: RenderableManager$Instance,
        primitiveIndex: number,
    ...
    public setBlendOrderAt(
        instance: RenderableManager$Instance,
        primitiveIndex: number,
        order: number,
    ): void;
    public getEnabledAttributesAt(
        instance: RenderableManager$Instance,
        primitiveIndex: number,
    ): number;
}
...
export class Camera {
    ...
    public setLensProjection(
        focalLength: number,
        near: number,
        far: number,
    ): void;
    public setCustomProjection(
        projection: mat4,
        near: number,
        far: number,
    ): void;
...
export class TransformManager {
    ...
    public setParent(
        instance: TransformManager$Instance,
        parent: TransformManager$Instance,
    ): void;
